          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <button
                ...
                className="group flex flex-col items-center gap-3 p-5 rounded-xl border-2 border-emerald-100 bg-emerald-50 hover:border-emerald-400 hover:bg-emerald-100 transition-all duration-200 text-left sm:col-span-2"
              >
                <div className="w-12 h-12 bg-emerald-600 group-hover:bg-emerald-700 rounded-xl flex items-center justify-center transition-colors duration-200">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                  </svg>
                </div>
                <div className="text-center">
                  <p className="font-semibold text-gray-900 text-sm">Loja de Vantagens</p>
                  <p className="text-gray-500 text-xs mt-1">Troque suas moedas por benefícios e veja seus resgates</p>
                </div>
              </button>
            </div>
          </div>
